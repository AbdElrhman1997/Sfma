...
const AboutSection = ({ title, description, lang }) => {
  return (
    <section
      className={`flex flex-col md:flex-row items-center justify-between gap-8 container mx-auto lg:pt-8 pt-0 ${
    ...
    >
      <div className="w-full md:w-1/2 flex flex-col justify-center">
        ...
        <p className="text-black text-justify mb-6 lg:leading-8 leading-6">
          {description}
        </p>
      </div>
