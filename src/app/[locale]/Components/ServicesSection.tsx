    ...
    >
      <div className="w-full md:w-1/2 flex flex-col justify-center">
        ...
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-6 rounded-xl bg-[#1DAEE5] flex flex-col items-center py-7">
            <Image
          ...
          <div className="col-span-6 rounded-xl bg-[#61B8A0] flex flex-col items-center py-7">
            <Image
