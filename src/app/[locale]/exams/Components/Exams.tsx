        ...
        >
            ...
            <div className="flex gap-x-4 border-t-2 border-t-[#D4D4D4] pt-2 flex-wrap">
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                <p className="lg:text-sm text-xs">
                  {t("exam.questions", { count: item?.question_count })}
                </p>
              </div>
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                <p className="lg:text-sm text-xs">
                  {t("exam.passing_score", { score: item?.passing_score })}
                </p>
              </div>
          ...
          <div className="mt-4 flex gap-3 items-center">
            ...
            <span className="lg:text-xs text-[10px] font-semibold text-start">
              {t("exam.valid_duration", { hours: item?.duration_minutes })}
            </span>
          </div>
        </div>
      ))}
