    ...
    >
      ...
      >
        <p className="font-semibold lg:text-xl text-base leading-8">
          اختبار دورة محترف إدارة مرافق (SFMP) سطر تاني{" "}
        </p>
        <div className="">
          <h3 className="lg:text-sm text-xs leading-7 text-[#555555] mb-2">
            اختبار معتمد لتقييم معرفتك في مفاهيم ومخرجات دورة محترف إدارة
            المرافق (SFMP). النجاح في هذا الاختبار يمنحك شهادة اجتياز رسمية من
            الجمعية.
          </h3>
          <div className="flex gap-x-4 border-t-2 border-t-[#D4D4D4]">
            <div className="flex items-center justify-start gap-2 mt-2">
              ...
              <p className=" lg:text-sm text-xs mt-2">20 سؤال - اختيار متعدد</p>
            </div>
            <div className="flex items-center justify-start gap-2 mt-2">
              ...
              <p className=" lg:text-sm text-xs mt-2">درجة النجاح : 70%</p>
            </div>
          </div>
          <div className="flex items-center justify-start gap-3 mt-2 ">
            ...
            <p className=" lg:text-sm text-xs mt-2">الرسوم : 350 ر.س</p>
          </div>
          <div className=" mt-4 flex items-center justify-start gap-x-4 text-primary font-semibold cursor-pointer">
            ...
            <span className="lg:text-xs text-[10px] font-semibold">
              الاختبار متاح لمدة 48 ساعة من تاريخ سداد الرسوم
            </span>
          </div>
        </div>
      </div>
