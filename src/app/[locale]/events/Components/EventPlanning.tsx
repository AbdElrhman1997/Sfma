...
const EventPlanning = () => {
  ...
  return (
    <section className="container mx-auto">
      <p className="text-[var(--main)] text-center lg:text-3xl text-xl font-bold mt-8">
        خدمة تنظيم الفعاليات
      </p>
      <p className="text-[#898989] text-center lg:max-w-3/4 mx-auto mt-2 leading-7 lg:text-base text-[13px]">
